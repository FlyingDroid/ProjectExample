 ...
 * <li>{@link com.weidukeji.agriculture.common.entity.HttpRequest#HttpRequest(String)}</li>
 * <li>{@link com.weidukeji.agriculture.common.entity.HttpRequest#HttpRequest(String, java.util.Map)}</li>
 * </ul>
 * <ul>
