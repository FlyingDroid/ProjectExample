...
import com.weidukeji.agriculture.common.service.Cache;
import com.weidukeji.agriculture.common.service.CacheFullRemoveType;
import com.weidukeji.agriculture.common.util.MapUtils;
 ...
 * <li>{@link #put(Object, com.weidukeji.agriculture.common.entity.CacheObject)} or {@link #put(Object, Object)} put element</li>
 * <li>{@link #get(Object)} get element</li>
 * <li>{@link #loadCache(String)} restore cache from file</li>
 * <li>{@link #saveCache(String, com.weidukeji.agriculture.common.service.impl.SimpleCache)} save cache to file</li>
 * </ul>
 * <ul>
...
public class SimpleCache<K, V> implements Cache<K, V>, Serializable {
     ...
     *        invalid. Rule of invalid see {@link #isExpired(com.weidukeji.agriculture.common.entity.CacheObject)}
     */
     ...
     * 
     * @param key key
     * @param value data of {@link com.weidukeji.agriculture.common.entity.CacheObject}
     * @return return null if cache is full and cannot remove one, else return the value be putted
     * @see com.weidukeji.agriculture.common.service.impl.SimpleCache#put(Object, com.weidukeji.agriculture.common.entity.CacheObject)
     */
    @Override
     ...
     * @param key
     * @return
     * @see com.weidukeji.agriculture.common.service.impl.SimpleCache#isExpired(com.weidukeji.agriculture.common.entity.CacheObject)
     */
     ...
     * <li>if {@link com.weidukeji.agriculture.common.entity.CacheObject#isExpired()} is true and {@link com.weidukeji.agriculture.common.entity.CacheObject#isForever()} is false, return true, else</li>
     * <li>if {@link com.weidukeji.agriculture.common.entity.CacheObject#getEnterTime()} add {@link #getValidTime()} less than current time, return true</li>
     * <li>return false</li>
     * </ul>
     * 
     * @param obj
    ...
    /**
     * save cache to file, the data of {@link com.weidukeji.agriculture.common.entity.CacheObject} should can be serializabled
     * 
     * @param <K>
     * @param <V>
     * @param filePath
