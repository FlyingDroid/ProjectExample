...
import com.weidukeji.agriculture.common.service.HttpCache;
 ...
 * <li>{@link #httpGet(HttpRequest, com.weidukeji.agriculture.common.util.HttpUtils.HttpListener)} http get asynchronous</li>
 * <li>{@link #httpGet(String, com.weidukeji.agriculture.common.util.HttpUtils.HttpListener)} http get asynchronous</li>
 * </ul>
 * <ul>
...
public class HttpUtils {
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see com.weidukeji.agriculture.common.util.HttpUtils#httpGet(HttpRequest)
     */
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see com.weidukeji.agriculture.common.util.HttpUtils#httpPost(HttpRequest)
     */
     ...
     *        {@link com.weidukeji.agriculture.common.util.HttpUtils#joinParas(java.util.Map)}
     * @return the content of the url, if null represents http error
     * @see com.weidukeji.agriculture.common.util.HttpUtils#httpPost(HttpRequest)
     */
