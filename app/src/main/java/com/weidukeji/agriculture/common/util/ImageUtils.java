...
public class ImageUtils {
     ...
     * @return
     * @see com.weidukeji.agriculture.common.util.ImageUtils#getInputStreamFromUrl(String, int, boolean)
     */
     ...
     * @param readTimeOutMillis
     * @return
     * @see com.weidukeji.agriculture.common.util.ImageUtils#getDrawableFromUrl(String, int, boolean)
     */
     ...
     * @param readTimeOut
     * @return
     * @see com.weidukeji.agriculture.common.util.ImageUtils#getBitmapFromUrl(String, int, boolean)
     */
