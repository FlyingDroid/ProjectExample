...
public class RandomUtils {
     ...
     * @param length
     * @return
     * @see com.weidukeji.agriculture.common.util.RandomUtils#getRandom(String source, int length)
     */
     ...
     *         <li>else see {@link com.weidukeji.agriculture.common.util.RandomUtils#getRandom(char[] sourceChar, int length)}</li>
     *         </ul>
     */
