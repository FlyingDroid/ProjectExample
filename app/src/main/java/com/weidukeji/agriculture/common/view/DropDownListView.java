package com.weidukeji.agriculture.common.view;
 ...
 * before</li>
 * <li>{@link #setOnDropDownListener(com.weidukeji.agriculture.common.view.DropDownListView.OnDropDownListener)} set listener which will be excuted when drop down, but you
