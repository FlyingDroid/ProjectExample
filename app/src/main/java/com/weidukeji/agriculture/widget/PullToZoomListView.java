...
public class PullToZoomListView extends ListView implements
    ...
    public FrameLayout getHeaderContainerView() {
    ...
    public interface OnPullScrollRefreshListener {
        void onStartPull();
    }

    private OnPullScrollRefreshListener pullScrollRefreshListener;

    public void setOnPullScrollRefreshListener(OnPullScrollRefreshListener pullScrollRefreshListener) {
        this.pullScrollRefreshListener = pullScrollRefreshListener;
    }
    ...
    public boolean onTouchEvent(MotionEvent paramMotionEvent) {
        switch (0xFF & paramMotionEvent.getAction()) {
            ...
            case 2:
                ...
                if (j == -1) {
                    ...
                    if (this.mHeaderContainer.getBottom() >= this.mHeaderHeight) {
                        ...
                        if (localLayoutParams.height < this.mHeaderHeight * 1.5)//可以向下拉伸的长度
                            this.mHeaderContainer
                                    .setLayoutParams(localLayoutParams);
                        this.mLastMotionY = paramMotionEvent.getY(j);
                        //	return true;
            ...
            case 1:
                reset();
                endScraling();
                if ((this.mHeaderContainer.getBottom() - this.mHeaderHeight) > 100) {
                    if (pullScrollRefreshListener != null) {
                        this.pullScrollRefreshListener.onStartPull();
                    }
                }
                break;
            case 3:
