...
public class SortAdapter extends BaseAdapter implements SectionIndexer {
	private List<LocalSortInfo>	list	= null;
	private Context				mContext;
	//public ImageLoader			imageLoader;

	public SortAdapter(Context mContext, List<LocalSortInfo> list) {
	 ...
	 * @param list
	 */
	public void updateListView(List<LocalSortInfo> list) {
		this.list = list;
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		final LocalSortInfo mContent = list.get(position);
		if(view == null) {
			viewHolder = new ViewHolder();
			view = LayoutInflater.from(mContext).inflate(R.layout.location_item_adapter, null);
